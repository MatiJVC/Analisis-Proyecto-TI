...
def require_ip_rate_limit(request: Request) -> None:
    """Sliding-window rate limit: RATE_LIMIT requests per WINDOW_SECONDS per client IP (no user authentication).
